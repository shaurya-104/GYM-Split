...
const programData = [
  {
    ...
    exercises: [
      ...
      { name: "Flat Bench Press", sets: "2 × failure", muscle: "Mid Chest" },
  ...
  },
  {
    ...
    subtitle: "Heavy Pressing & Biceps",
    exercises: [
      ...
      { name: "Preacher Curls", sets: "2 × failure", muscle: "Biceps" },
      { name: "Superman Curls", sets: "2 × failure", muscle: "Biceps" },
    ]
  },
  {
    label: "Day 3",
    ...
    subtitle: "Quad Focus",
    exercises: [
      { name: "Leg Extensions", sets: "2 × failure", muscle: "Quads" },
      { name: "Squats", sets: "2 × failure", muscle: "Quads/Glutes" },
      { name: "Seated Leg Extensions", sets: "2 × failure", muscle: "Quads" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Chest-Supported Machine Rows", sets: "2 × failure", muscle: "Upper Back" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Overhead Cable Tricep Extensions", sets: "2 × failure", muscle: "Triceps" },
      { name: "Incline Dumbbell Curls", sets: "2 × failure", muscle: "Biceps" },
      { name: "Standing Hammer Curls", sets: "2 × failure", muscle: "Brachialis" },
      { name: "Preacher Curls", sets: "2 × failure", muscle: "Biceps" },
    ]
  },
  {
    ...
    exercises: [
      { name: "Squats", sets: "2 × failure", muscle: "Quads/Glutes" },
      { name: "Romanian Deadlift", sets: "2 × failure", muscle: "Hamstrings" },
      { name: "Leg Extensions", sets: "2 × failure", muscle: "Quads" },
      { name: "Seated Leg Curls", sets: "2 × failure", muscle: "Hamstrings" },
      { name: "Standing Calf Raises", sets: "2 × failure", muscle: "Calves" },
